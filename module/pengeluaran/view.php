...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Lihat Data Pengeluaran</li>
	</ol>
</section>
...
<section class="invoice">
    ...
    <div class="row invoice-info">
        ...
        <div class="col-sm-6 col-xs-12 invoice-col">
			Detail Pengeluaran <!-- Jenis Info/Faktur --> 
			<address>
        ...
        <div class="col-sm-6 col-xs-12 invoice-col">
        	<div class="pull-right">
        		<b>No Pengeluaran #007612</b><br>
				<b>Jenis:</b> 4F3S8J<br>
				<br><br>
				<b>Total: Rp.</b> 200.000,00,-
        	</div>
        </div>
        <!-- /.col -->
    </div>
	...
	<div class="row">
		<div class="col-xs-12 table-responsive">
			<table id="tabel_lihat_pengeluaran" class="table table-striped">
				<thead>
					<tr>
						<th>No</th>
						<th>Keterangan</th>
	...
	<div class="row">
		<div class="col-xs-12">
			<a href="<?= base_url."index.php?m=pengeluaran&p=list" ?>" class="btn btn-default btn-lg pull-right" role=button>
